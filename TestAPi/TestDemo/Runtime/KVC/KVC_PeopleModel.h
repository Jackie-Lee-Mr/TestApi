...
/*
 ...
 属性：setter ，getter ，成员变量
 
 Getter:
 
 valueForKey:name的调用顺序
 
     1.先查看方法是否实现，优先查找 getName ,name ,getIsName 是否实现，如果实现就不会走2 ， 如果都没有实现走2
 
     2.+(BOOL)accessInstanceVariablesDirectly，return YES ，return NO ->4
 ...
 setValue:value forKey:name
     ...
     2.+(BOOL)accessInstanceVariablesDirectly，return YES ，return ->4
