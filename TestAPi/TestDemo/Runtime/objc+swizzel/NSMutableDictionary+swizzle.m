...
+ (void)load {
    [super load];
    //setObject:forKey:
    Method fromMethod1 = class_getInstanceMethod(objc_getClass("__NSDictionaryM"), @selector(setObject:forKey:));
    
    Method toMethod1 = class_getInstanceMethod(objc_getClass("__NSDictionaryM"), @selector(JACKIE_objcSetObject:forKey:));
    
    method_exchangeImplementations(fromMethod1, toMethod1);
    
    //dictionaryWithObject:forKey:
    Method fromMethod2 = class_getInstanceMethod(objc_getClass("__NSDictionaryM"), @selector(dictionaryWithObject:forKey:));
    
    Method toMethod2 = class_getInstanceMethod(objc_getClass("__NSDictionaryM"), @selector(JACKIE_objcDictionaryWithObject:forKey:));
